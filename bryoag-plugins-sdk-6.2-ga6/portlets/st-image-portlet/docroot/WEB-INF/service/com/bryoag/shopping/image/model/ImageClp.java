...
import com.bryoag.shopping.image.service.ClpSerializer;
...
public class ImageClp extends BaseModelImpl<Image> implements Image {
	...
	public void setAssetId(long assetId) {
		...
		if (_imageRemoteModel != null) {
			try {
				...
				method.invoke(_imageRemoteModel, assetId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setAssetType(String assetType) {
		...
		if (_imageRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setAssetType", String.class);

				method.invoke(_imageRemoteModel, assetType);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	private Class<?> _clpSerializerClass = com.bryoag.shopping.image.service.ClpSerializer.class;
}