...
public class ImageLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return ImageLocalServiceUtil.addImage((com.bryoag.shopping.image.model.Image)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return ImageLocalServiceUtil.deleteImage((com.bryoag.shopping.image.model.Image)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return ImageLocalServiceUtil.updateImage((com.bryoag.shopping.image.model.Image)arguments[0]);
		}
