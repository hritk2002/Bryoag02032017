...
import com.bryoag.image.model.ImageModel;
import com.bryoag.image.model.ImageSoap;
...
/**
 * The base model implementation for the Image service. Represents a row in the &quot;st_Image&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.bryoag.image.model.ImageModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ImageImpl}.
 * </p>
 *
 * @author deepakgupta02
 * @see ImageImpl
 * @see com.bryoag.image.model.Image
 * @see com.bryoag.image.model.ImageModel
 * @generated
 */
@JSON(strict = true)
public class ImageModelImpl extends BaseModelImpl<Image> implements ImageModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a image model instance should use the {@link com.bryoag.image.model.Image} interface instead.
	 */
	public static final String TABLE_NAME = "st_Image";
	...
	public static final String TABLE_SQL_CREATE = "create table st_Image (imageId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,categoryId LONG,productId LONG,smallImagePath STRING null,mediumImagePath STRING null,largeImagePath STRING null)";
	public static final String TABLE_SQL_DROP = "drop table st_Image";
	public static final String ORDER_BY_JPQL = " ORDER BY image.imageId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY st_Image.imageId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.bryoag.image.model.Image"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.bryoag.image.model.Image"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.bryoag.image.model.Image"),
			true);
	public static long CATEGORYID_COLUMN_BITMASK = 1L;
	public static long COMPANYID_COLUMN_BITMASK = 2L;
	public static long GROUPID_COLUMN_BITMASK = 4L;
	public static long IMAGEID_COLUMN_BITMASK = 8L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.bryoag.image.model.Image"));
	...
	public void resetOriginalValues() {
		...
		imageModelImpl._originalProductId = imageModelImpl._productId;

		imageModelImpl._setOriginalProductId = false;
