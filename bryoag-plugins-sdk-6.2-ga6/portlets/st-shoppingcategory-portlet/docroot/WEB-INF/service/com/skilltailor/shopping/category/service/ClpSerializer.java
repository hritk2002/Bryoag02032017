...
import com.skilltailor.shopping.category.model.shoppingcategoryClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"st-shoppingcategory-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "st-shoppingcategory-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.skilltailor.shopping.category.model.impl.shoppingcategoryImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new com.skilltailor.shopping.category.NoSuchshoppingcategoryException();
		}
